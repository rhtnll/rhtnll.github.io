		...
		// }
		// var url = decode("7f42aHR0cDovLKRDp212dmlkZW8xMC5tZWl0dWRhdGEuY29tLzVkZGI5ZTc5YTg2MzIwMmZqNXdqYjA2OTY4X0gyNjRfTVA1ZGRjOGrB3YubXA0");
		// console.log(url);
	
		var document = {
		    URL: "https://v.qq.com/x/cover/nfdpz32y9qn8mkj.html",
		    referrer: ""
		...
		function innn(a, b, c, d, e){
		    function f(a) {
		        return "string" === b ? knnn(a) : "boolean" === b ? Boolean(a) : a
		    }
		...
		// var buffer = new FileReader().readAsText(new File([""],'js/tx-ckey.wasm'));
		...
		function getckey(platform, appVer, vid, empty_str="", guid, tm){
		    ...
		    return innn('getckey', 'string', c, _args, undefined)
		...
		console.log(getckey('10201', '3.5.57', 'v0033rsgpkm', '', 'd1384f3028935f6465a473a5a07113b5', '1584782550'));

		function get(vid , tm){
			return getckey('10201', '3.5.57', vid, '', 'd1384f3028935f6465a473a5a07113b5', tm)
		}
	...
	http.createServer(function(req, res){
		...
		res.write(get(params.vid , params.tm));
	    res.end();
	}).listen(9797);
	
	console.log('Server running at http://127.0.0.1:9797/');
